  ...
  return (
    <main className="main main__privacy">
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые Индивидуальный предприниматель Пакулева Яна Андреевна (далее
        – Оператор).
      </p>
      <p>
      ...
      <p>
        ...
        сети интернет по сетевому адресу https://.
      </p>
      <p>
      ...
      <p>
        ...
        материалам, содержащимся на веб-сайте https://.
      </p>
      <p>
        ...
        почты yapakuleva@gmail.com с пометкой «Отказ от уведомлений о новых
      ...
      <p>
        ...
        специальные формы, расположенные на сайте https:// или
      ...
      <p>
        ...
        уведомление на адрес электронной почты Оператора yapakuleva@gmail.com с
      ...
      <p>
        ...
        электронный адрес Оператора yapakuleva@gmail.com с пометкой «Отзыв согласия
      ...
      <p>
        ...
        Оператору с помощью электронной почты yapakuleva@gmail.com.
      </p>
      <p>
